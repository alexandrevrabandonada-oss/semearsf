        ...
        <main className="mx-auto max-w-6xl px-4 py-8 md:py-12">
            <header className="mb-12 text-center md:text-left">
                ...
                <p className="mx-auto max-w-3xl text-lg text-texto/80 md:mx-0 md:text-xl">
                    Navegue pelas rotas e recortes territoriais monitorados. Descubra os impactos reais e as soluções coletivas em cada região da Bacia da Baía de Guanabara.
                </p>
            </header>
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {corridors.map((c) => (
                        <Link
                            ...
                            className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-ciano/20 bg-fundo-card/50 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-cta/50 hover:bg-ciano/10 hover:shadow-2xl hover:shadow-ciano/10"
                        >
                            {c.featured && (
                                <div className="absolute right-0 top-0 rounded-bl-xl bg-cta/90 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-fundo">
                                    Destaque
                                </div>
                            )}
                            <div className="mb-4 flex h-48 w-full items-center justify-center rounded-2xl bg-gradient-to-br from-ciano/5 to-primaria/20 overflow-hidden">
                                {/* Visual placeholder for geometry/map visual */}
                                <div className="relative flex h-full w-full items-center justify-center text-ciano/20 transition-transform duration-500 group-hover:scale-105">
